    ...
    var bodyContent = (
        <>
            ...
            <Form.Group as={Row} className="gap-3" controlId="formSongName">
                ...
                {props.isAddRequest ? (
                    <Col xs="12">
                        <Form.Check inline label="Regular" name="vip-radio" type="radio" id="reqular-radio" defaultChecked={true} onChange={handleVipUpdateRegular} />
                        <Form.Check inline label="Use Vip?" name="vip-radio" type="radio" id="vip-radio" onChange={handleVipUpdateVip} />
                        <Form.Check inline label="Use Super Vip?" name="vip-radio" type="radio" id="super-vip-radio" onChange={handleVipUpdateSuperVip} />
                    </Col>) : (<></>)}
            </Form.Group>
        </>);
