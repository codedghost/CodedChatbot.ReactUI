...
export function ChangePlaylistStateModal (props: ChangePlaylistStateProps) {
    ...
    var errorMessageContent = (props.errorMessage.trim() !== "") ? (<Alert variant="danger">{props.errorMessage}</Alert>) : (<></>);
    ...
    var bodyContent = (
        <>
            ...
            <Form.Group as={Row} className="gap-3" controlId="formChangePlaylist">
                <Form.Label column xs="4">Current State:</Form.Label>
                <Form.Label column xs="6">{props.currentState}</Form.Label>
                <Form.Label column xs="4">New State:</Form.Label>
                <Col xs="6">
    ...
    var footerContent = (
        <>
            <Button onClick={() => {props.updatePlaylistState(selectedUpdateState)}}>
                Update
            </Button>
